...
# TODO Pydantic Model für die Ausgabe
#  Erstelle eine Pydantic Model für die Ausgabe. Es enthält keine 'origin', ansonsten ist gleich dem 'Key' Model.

# TODO Pydantic Model für die Ausgabe
#  gib das neue Model für die Ausgabe zurück statt dem 'Key' Model.
@router.get('/')
